...
public class PowIntProvider extends IntProvider {
    public static final MapCodec<PowIntProvider> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        ...
        ).apply(instance, PowIntProvider::new);
    });
    public final IntProvider a;
    public final IntProvider b;

    public PowIntProvider(IntProvider a, IntProvider b) {
        this.a = a;
        this.b = b;
    }
