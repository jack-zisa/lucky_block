...
public class LuckyBlockAddonsResourcePackCreator implements ResourcePackProvider {
    ...
    public void register(Consumer<ResourcePackProfile> profileAdder) {
        profileAdder.accept(ResourcePackProfile.create(RESOURCE_PACK_INFO, new LuckyBlockAddonsResourcePack.Factory(type), ResourceType.CLIENT_RESOURCES, new ResourcePackPosition(true, ResourcePackProfile.InsertionPosition.TOP, true)));
    }
}