...
public record EntityProviderType<P extends EntityProvider>(MapCodec<P> codec) {
    ...
    public static final EntityProviderType<SimpleListEntityProvider> SIMPLE_LIST_ENTITY_PROVIDER = new EntityProviderType<>(SimpleListEntityProvider.CODEC);
    ...
    public static final EntityProviderType<AllInRangeEntityProvider> ALL_IN_RANGE_ENTITY_PROVIDER = new EntityProviderType<>(AllInRangeEntityProvider.CODEC);
    ...
    public static void init() {
        ...
        registerEntityProviderType(Identifier.of(LuckyBlockMod.NAMESPACE, "simple_list_entity_provider"), SIMPLE_LIST_ENTITY_PROVIDER);
        ...
        registerEntityProviderType(Identifier.of(LuckyBlockMod.NAMESPACE, "all_in_range_entity_provider"), ALL_IN_RANGE_ENTITY_PROVIDER);
