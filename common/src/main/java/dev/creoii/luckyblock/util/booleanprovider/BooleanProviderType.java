...
public record BooleanProviderType<P extends BooleanProvider>(MapCodec<P> codec) {
    ...
    public static final BooleanProviderType<EntityBooleanProvider> ENTITY_BOOLEAN_PROVIDER = new BooleanProviderType<>(EntityBooleanProvider.CODEC);
    ...
    public static void init() {
        ...
        registerBooleanProviderType(Identifier.of(LuckyBlockMod.NAMESPACE, "entity_boolean_provider"), ENTITY_BOOLEAN_PROVIDER);
    }
