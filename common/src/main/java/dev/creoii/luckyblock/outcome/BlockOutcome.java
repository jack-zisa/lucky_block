...
public class BlockOutcome extends Outcome {
    ...
    public BlockOutcome(int luck, float chance, Optional<Integer> delay, Optional<VecProvider> pos, BlockStateProvider stateProvider, Optional<ContextualNbtCompound> blockEntity, Optional<Shape> shape) {
